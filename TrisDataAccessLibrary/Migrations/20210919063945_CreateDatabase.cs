        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TurnPiece = table.Column<int>(type: "int", nullable: false),
                    Winner = table.Column<int>(type: "int", nullable: false),
                    BoardString = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_AspNetUsers_PlayerAId",
                        column: x => x.PlayerAId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rooms_AspNetUsers_PlayerBId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_PlayerAId",
                table: "Rooms",
                column: "PlayerAId");

            migrationBuilder.CreateIndex(
                name: "IX_Rooms_PlayerBId",
                table: "Rooms",
                column: "PlayerBId");
        }
